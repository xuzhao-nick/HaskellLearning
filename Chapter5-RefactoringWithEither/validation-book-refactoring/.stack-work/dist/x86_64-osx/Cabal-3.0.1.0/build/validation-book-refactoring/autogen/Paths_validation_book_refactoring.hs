...
module Paths_validation_book_refactoring (
    version,
...
getLibDir = catchIO (getEnv "validation_book_refactoring_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "validation_book_refactoring_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "validation_book_refactoring_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "validation_book_refactoring_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "validation_book_refactoring_sysconfdir") (\_ -> return sysconfdir)
